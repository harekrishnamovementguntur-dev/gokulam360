...
test('Offering rejects inverted dates',()=>assert.throws(()=>createProgramOffering({...ctx,input:{program_id:'p',academic_year:'2026',start_date:'2026-02-01',end_date:'2026-01-01'}}),/start_date/));
