    ...
    <div className="min-h-screen bg-aurora relative">
      ...
      <div className="relative max-w-3xl mx-auto p-4 md:p-8 space-y-5">
        ...
        <section className="rounded-2xl glass overflow-hidden">
          <div className="px-5 py-4 border-b flex items-center gap-2"><Calendar size={16} className="text-primary" /><div><div className="font-semibold text-sm">Featured Events</div><div className="text-xs text-muted-foreground">Events selected for your programs</div></div></div>
