...
function ForgotPasswordPanel({ onClose }) {
  ...
  const sendOtp = async (event) => {
    ...
    try {
      const result = await request('auth/forgot-password/request-otp', { method: 'POST', body: JSON.stringify({ email, mobile }) });
